    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(related_name='users_customoauthapplication', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'default_permissions': ('add', 'change', 'delete', 'view'),
                'verbose_name': 'Konza oauth application',
                'verbose_name_plural': 'Konza oauth applications',
            },
        ),
    ]
